...
int main()
{
	...
	//glBufferData(GL_ARRAY_BUFFER, sizeof(grid.vertices[0]) * grid.vertices.size(), grid.vertices.data(), GL_STATIC_DRAW);

	//glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);
	//glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(grid.indices()[0]) * grid.indices().size(), grid.indices().data(), GL_STATIC_DRAW);
